...
path = pjoin('/','Users','CarolinaDunbar','Documents','Segmentation','Cells','Cell_Segments')
...
np.savetxt('/Users/CarolinaDunbar/Documents/Segmentation/cells/Cell_Segments/LV_Elems+1_17.txt',elems,'%2i',delimiter=' , ') 			#enter name of node segement
